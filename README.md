...
![Kubernetes Logo](./images/k8s-logo.png)
...
- **[Phase 1](./phase-1/)**: The absolute basics! Core concepts, `kubectl`, Pods, and Deployments.
  - [Core Concepts](./phase-1/1.core-concepts.md)
  - [Kubectl and API](./phase-1/2.kubectl-and-api.md)
  - [Deployments and ReplicaSets](./phase-1/3.deployments-and-replicasets.md)
  - [Reconciliation Loop](./phase-1/4.reconciliation-loop.md)
  - [Labels and Selectors](./phase-1/5.labels-and-selectors.md)
  - [Why Pods Exist](./phase-1/6.why-pods-exist.md)
  - [How Containers Share One IP](./phase-1/7.how-containers-share-one-ip.md)
  - [Why K8s Have Namespaces](./phase-1/8.why-k8s-have-namespaces.md)
  - [Why K8s Services Exist?](./phase-1/9-why-k8s-services-exist?.md)
